...
- Incorporar `assets/images/lichia.png` como elemento ilustrativo do resumo do cultivo, com tratamento responsivo e descrição semântica.
...
- Usa o Google Maps já configurado e o asset existente `assets/images/lichia.png`; não requer nova dependência nem alteração de schema do banco.
